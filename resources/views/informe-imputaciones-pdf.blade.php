    ...
    <div class="col-left">
        ...
        <div class="panel">
            ...
            <div class="saldo-box">
                ...
                <br><span style="color:#999;font-size:8pt;">@if($es_turno)({{ number_format($hist_extras_dias_fest, 0, ',', '') }}d fest/desc = {{ number_format($hist_extras_horas_fest, 1, ',', '') }}h + {{ number_format($hist_extras_horas_resto, 1, ',', '') }}h ext)@else({{ number_format($hist_extras_horas_resto, 1, ',', '') }}h ext)@endif</span>
            </div>
            @if(!empty($sin_contrato) && $sin_contrato)
    ...
    <div class="col-right">
        <table class="tbl-main">
            ...
            @php
                ...
                if ($dia['es_descanso_efectivo'] && !$trabajaFestivo && !$trabajaDescanso && !$dia['is_rotatorio']) $badges[] = ['Descanso', '#F3F4F6', '#6B7280'];
